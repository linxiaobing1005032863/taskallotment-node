var app = angular.module('itemExportNew', ['toastr','angularjs-dropdown-multiselect']);
app.controller('itemExportNewCtrl', function($scope, itemSer,$state,toastr,$stateParams){
    ...
    $scope.workersAddFun = function(){
        ...
        window.open(`/itemExportNew/exportNew${encode(obj,true)}`);
    };
