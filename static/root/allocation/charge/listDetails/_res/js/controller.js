var app = angular.module('chargListDetails', ['ng-pagination','toastr']);
app.controller('chargListDetailsCtrl',function($scope,chargeSer,toastr,$stateParams,$state,$location){
    ...
    function activatePage(page) {
        ...
        chargeSer.getId(listData).then(function(response){
