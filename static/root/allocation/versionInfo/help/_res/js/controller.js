var app = angular.module('help', [{
    files:[
        "root/allocation/versionInfo/help/_res/js/service.js"
    ]
}]);
app.controller('helpCtrl',function ($scope,$state) {
    ...
    $scope.detail = function(){
        if($scope.idList){
            $state.go('root.allocation.versionInfo.help.detail[12]',{id:$scope.idList,page:$scope.page});
    ...
    $scope.edit = function(){
        if($scope.idList){
            $state.go('root.allocation.versionInfo.help.edit[12]',{id:$scope.idList,page:$scope.page});
    ...
    $scope.answer = function(){
        if($scope.idList){
            $state.go('root.allocation.versionInfo.help.answer[12]',{id:$scope.idList,page:$scope.page});
