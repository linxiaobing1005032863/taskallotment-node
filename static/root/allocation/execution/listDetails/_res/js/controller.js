var app = angular.module('executionListDetails', ['ng-pagination','toastr']);
app.controller('executionListDetailsCtrl',function($scope,executSer,toastr,$stateParams,$state,$location){
    ...
    function activatePage(page) {
        ...
        executSer.exectId(listData).then(function(response){
