var app = angular.module('distListDetails', ['ng-pagination','toastr']);
app.controller('distListDetailsCtrl',function($scope,distSer,toastr,$stateParams,$state,$location){
    ...
    function activatePage(page) {
        ...
        distSer.distriId(listData).then(function(response){
