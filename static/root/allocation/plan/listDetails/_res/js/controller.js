var app = angular.module('planListDetails', ['ng-pagination','toastr']);
app.controller('planListDetailsCtrl',function($scope,planSer,toastr,$stateParams,$state,$location){
    ...
    function activatePage(page) {
        ...
        planSer.getId(listData).then(function(response){
            if(response.data.code == 0){
